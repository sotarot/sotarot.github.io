...
var Deck = (function () {
  ...
  function _card(i) {
    ...
    function onMousedown(e) {
      ...
      function onMouseup(e) {
        if (isFlippable && Date.now() - starttime < 135) {
          // flip sides
  ...
  function SuitName(suit) {
    ...
    return suit === 0 ? 'spades' : suit === 1 ? 'hearts' : suit === 2 ? 'clubs' : suit === 3 ? 'diamonds' : 'majorarcana';
  }
    ...
    card: function card(_card3) {
      ...
      _card3.shuffle = function (cb) {
        ...
        _card3.animateTo({
          ...
          x: plusminus(Math.random() * 16 + 20) * ____fontSize / 16,
          y: -z,
          rot: -3
        });
        _card3.animateTo({
    ...
    card: function card(_card4) {
      ...
      _card4.poker = function (i, len, cb) {
        ...
        _card4.animateTo({
          ...
          x: Math.round((i - .1) * 150 * __fontSize / 16),
          y: Math.round(-110 * __fontSize / 16) + 500,
          rot: Math.random() < 0.5 ? 0 : 180,
    ...
    card: function card(_card7) {
      ...
      _card7.bysuit = function (cb) {
        ...
        _card7.animateTo({
          ...
          x: -Math.round((15 - rank) * 20 * ___fontSize / 16),
          y: -Math.round((1.5 - suit) * 100 * ___fontSize / 16),
          rot: 0,
  ...
  function Deck(majorarcanas) {
    // init cards array
    var cards = new Array(majorarcanas ? 78 : 78);
